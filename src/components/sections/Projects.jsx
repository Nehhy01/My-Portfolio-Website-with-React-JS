    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          :key="project.id"
          className="group relative bg-linear-to-br from-gray-800/50 to-blue-900/30 rounded-3xl overflow-hidden border background-blur-sm hover:boder-blue-400/40 transition-all duration-500 hover:transform hover:-translate-y-2"
          :className="project.borderColor"
          data-aoss="fade-up"
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3 flex-wrap mb-4">
              <span
                ...
                :key="tech.name"
                className="py-1 px-3 rounded border text-white"
            ...
            <div className="flex gap-5">
              ...
              >
                <component :is="link.icon" className="w-4 h-4"></component>
                {{ link.name }}
              </a>
            </div>
          </div>
      ...
      <div className="text-center mt-16" data-aoss="fade-up">
        ...
        <button  className=" cursor-pointer px-8 py-4 rounded-xl bg-linear-to-r group from-blue-500 to-cyan-500 text-white font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105 flex items-center">View All Projects <ArrowRightIcon className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-all duration-300"/> </button>
        ...
        <ChatBubbleLeftRightIcon className="w-5 h-5 mr-2 group-hover:translate-x-1 transition-all duration-300"/> Discuss Projects  </button>
